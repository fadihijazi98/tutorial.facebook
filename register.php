        ...
        <div class="mt-6">
          ...
          <form class="mt-8">
            <div class="mx-auto max-w-lg">
              ...
              <div class="flex justify-between"><label class="block text-gray-500 font-bold my-4"><span class="py-2 text-sm text-gray-600 leading-snug">  </span></label> <label class="block text-gray-500 font-bold my-4"><a
                    href="#"
                    class="cursor-pointer tracking-tighter text-black border-b-2 border-gray-200 hover:border-gray-400"><span>
                    </span></a></label></div> <button class="mt-3 text-lg font-semibold 
